...
export const PATH_TO_OPERATION: Record<string, string> = {
  ...
  "GET:/{accountId}/boards/{boardId}/accesses.json": "ListBoardAccesses",
  ...
  "GET:/{accountId}/boards/{boardId}/columns/{columnId}/cards.json": "ListColumnCards",
  ...
  "GET:/{accountId}/boards/{boardId}/webhooks/{webhookId}/deliveries.json": "ListWebhookDeliveries",
  ...
  "POST:/{accountId}/users/{userId}/data_exports.json": "CreateUserDataExport",
  "GET:/{accountId}/users/{userId}/data_exports/{exportId}": "GetUserDataExport",
  "POST:/{accountId}/users/{userId}/email_addresses.json": "RequestEmailAddressChange",
  "POST:/{accountId}/users/{userId}/email_addresses/{emailAddressToken}/confirmation.json": "ConfirmEmailAddressChange",
